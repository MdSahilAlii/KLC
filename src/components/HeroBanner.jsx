...
const slides = [
  {
    ...
    videoUrl: 'https://youtu.be/btArnQbeZXg?si=QZxz7x0Z9H7f0rf9'
  },
  {
...
const HeroBanner = () => {
  ...
  return (
    <section className="relative h-[calc(100vh-80px)] bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
                  ...
                  <div className="flex flex-wrap gap-4 pt-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex items-center">
                        <StarIcon />
                        <span className="text-lg font-semibold text-yellow-400 ml-1">{slide.stats.rating}</span>
                      </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-gradient-to-tr from-gray-800 to-gray-900 p-2 rounded-3xl shadow-2xl">
                    ...
                    <motion.div
                      ...
                      className="absolute inset-0 flex items-center justify-center bg-black/40 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer backdrop-blur-sm"
                    >
                      <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl transform hover:scale-110 transition-transform duration-200">
                        <PlayIcon />
                      </div>
                    </motion.div>
                  </div>
        ...
        {isVideoModalOpen && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setIsVideoModalOpen(false)}
                className="absolute top-6 right-6 z-20 w-12 h-12 bg-black/70 hover:bg-black/90 rounded-full flex items-center justify-center text-white transition-all duration-200 backdrop-blur-sm border border-gray-700"
              >
                <CloseIcon />
              </button>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/80 to-transparent p-6 sm:p-8">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                    <div className="flex items-center space-x-2">
                      <span className="text-blue-400 font-semibold text-sm sm:text-base">{slide.stats.students}</span>
                      <span className="text-gray-400 text-xs sm:text-sm">Students</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <StarIcon />
                      <span className="text-yellow-400 font-semibold text-sm sm:text-base">{slide.stats.rating}</span>
                      <span className="text-gray-400 text-xs sm:text-sm">Rating</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-purple-400 font-semibold text-sm sm:text-base">{slide.stats.courses}</span>
                      <span className="text-gray-400 text-xs sm:text-sm">Courses</span>
                    </div>
                  </div>
                </div>
              </div>
