  ...
  const courses = [
    {
      ...
      programs: [
        { name: 'Class 6-8', description: '"Designed to build a strong foundation in Mathematics, Science, and English by enhancing conceptual clarity, critical thinking, and communication skills for future academic success.', students: '300+' },
        { name: 'Class 9-10', description: 'Comprehensive board exam preparation that strengthens core concepts and sharpens problem-solving skills for academic excellence.', students: '250+' }
      ]
    },
    {
